  ...
  ({ close, title, children }: TServerScreenLayoutProps) => {
    ...
    return (
      ...
      >
        <div
          className={cn(
            'relative flex h-full max-h-[calc(100dvh-2rem)] w-full max-w-5xl flex-col overflow-hidden rounded-lg bg-background text-foreground [clip-path:inset(0_round_0.75rem)] [-webkit-mask-image:-webkit-radial-gradient(white,black)] md:h-[85dvh]',
